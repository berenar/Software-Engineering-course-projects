...
/*
Escribirá texto en uno o varios inodos haciendo uso de reservar_inodo ('f', 6) para obtener un nº de inodo,
...
// mi_truncar_f(1,0);
	...
	/*Pasarlo como argumento escribiéndolo en consola y 
	utilizar la función strlen() para calcular su longitud*/
